...
const navigation = [
  ...
  },
  {
    ...
    href: "/resource-hub",
    items: [
      { name: "Articles & News", href: "/middleeast/blog" },
...
const topNavLinks = [
  ...
  { name: "Articles", href: "/middleeast/blog" },
  { name: "Institution", href: "/institution" },
  { name: "Contact Us", href: "/middleeast/contact-us" },
  ...
  return (
    <header className="w-full bg-white border-b border-gray-200 sticky top-0 z-50 shadow-xs">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
        {/* Logo */}
        <Link href="/middleeast" className="flex items-center gap-2 group">
