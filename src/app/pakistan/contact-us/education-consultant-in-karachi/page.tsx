...
export default function EducationConsultantKarachi() {
    ...
    return (
        <main className="min-h-screen bg-gray-50 text-gray-800 font-sans">
            ...
            {/* ---------------- HERO SECTION ---------------- */}
            <PageHero
                title="Professional Education Consultant in Karachi"
            ...
            <section className="py-12 md:py-16 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h2 className="text-3xl font-bold text-gray-900 mb-8">Karachi Branch</h2>
                    ...
                    <div className="grid lg:grid-cols-3 gap-8">
                        ...
                        <div className="lg:col-span-2 grid sm:grid-cols-2 gap-6">
                            ...
                            <div className="sm:col-span-2 bg-slate-50 border border-slate-200 p-6 rounded-xl flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600 mt-1">Nordic Tower, 11th Floor, Office 112, Block 428, Street 2802, Seef, Karachi</p>
                                </div>
                            </div>
                        ...
                        <div className="h-full min-h-[300px] bg-gray-200 rounded-xl overflow-hidden shadow-sm border border-gray-200">
                            <iframe
                                title="JnS Education Karachi Map"
                                src="https://maps.google.com/maps?q=JnS%20Education%20Karachi%20Nordic%20Tower&t=&z=15&ie=UTF8&iwloc=&output=embed"
                                width="100%"
                                height="100%"
                                style={{ border: 0 }}
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                        ...
                        <div className="lg:col-span-2 prose prose-lg max-w-none text-gray-700">
                            ...
                            <h1 className="best-heading text-black mb-3">
                                JnS Education: Your Study Abroad Consultant in Karachi & Seef
                            </h1>
                            <p className="font mb-4">
                                There’s a moment many students in Karachi quietly experience but rarely talk about  that feeling of sitting in front of a laptop, trying to choose a country or university, and suddenly realizing how overwhelming the whole thing really is. One page leads to another, deadlines blur together, scholarships feel confusing, and before you know it… you’re more unsure than when you started.
                            </p>
                            <p className="font mb-4">
                            ...
                            <p className="font mb-4">
                                That’s what makes us a trusted study abroad consultant in Karachi and especially in areas like Seef, where students are eager to explore international opportunities but unsure how to start
                            </p>

                            <h2 className="best-heading text-black mb-3">
                                Why Students in Karachi Choose JnS Education
                            </h2>
                            <p className="mb-4">
                            ...
                            <p className="mb-4">
                                As one of the top study abroad consultants in Karachi, we take time to understand your personality, goals, strengths, limitations, dreams even the fears you don’t say out loud.
                            ...
                            <p className="mb-4">
                                That’s why so many families consider us the trusted education consultants in Karachi because we offer clarity, not confusion.
                            </p>
                            <h2 className="best-heading text-black mb-3">
                                Guidance From Seef to Any Destination You Dream Of
                            </h2>
                            <p className="mb-4">
                                Whether you’re living in Seef, Manama, or anywhere else in Karachi, you get full support from the moment you reach out to the moment you land abroad. As a dedicated study abroad consultant in Seef, we guide you through:
                            </p>
                            ...
                            <h2 className="best-heading text-black mb-3">
                                Why JnS Education is the Best Study Abroad Consultant in Karachi
                            </h2>
                            <p className="mb-4">
                                With over 20 years of international student support, JnS Education Karachi offers:
                            </p>
                            <ul className="list-disc list-inside mb-4">
                            ...
                            <p className="mb-4">
                                Speak to an Expert JnS Counsellor now & find the best-fit destination for your ambitions from our Seef, Karachi office.
                            </p>
                            <h2 className="best-heading text-black mb-3">
                                What Makes JnS Education Stand Out in Karachi?
                            </h2>
                            ...
                            <p className="mb-4">
                                That experience is what places us among the best education consultants in Seef and Karachi overall.
                            </p>
                            <h6 className="text-black mb-3">
                            ...
                            <p className="mb-4">
                                If you’re looking for an affordable education consultant in Karachi without compromising on expertise, you’ll feel right at home with JnS Education.
            ...
            <section className="bg-primary text-white py-16 px-4 md:px-8">
                <div className="max-w-5xl mx-auto">
                    <h2 className="best-heading mb-10 text-white">
                        Frequently Asked Questions (FAQs) – Studying in Karachi
                    </h2>
...
const faqData = [
    {
        question: "1. Why JnS Education, Karachi? Why should I choose it to assist me in studying overseas?",
